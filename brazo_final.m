...
prompt= 'Cuanto deseas rotar en grados la primera extremidad del brazo :\n';
theta1 = input(prompt);
prompt= 'Cuanto deseas rotar en grados de la segunda extremidad del brazo :\n';
theta2 = input(prompt);
...
for theta2_rad=0:-0.09:theta2_rad_fin
    ...
    Ttx2=[1   0    0   l2;
      ...
      line([p2(1) p3(1)], [p2(2) p3(2)], [p2(2) p3(2)],'color',[0 0 0],'linewidth',5);
